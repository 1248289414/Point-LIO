...
void readParameters(rclcpp::Node::SharedPtr node_ptr)
{
  ...
  node_ptr->declare_parameter<double>("mapping.satu_acc", 3.0);
  node_ptr->declare_parameter<double>("mapping.satu_gyro", 35.0);
  node_ptr->declare_parameter<double>("mapping.acc_norm", 1.0);
  node_ptr->declare_parameter<float>("mapping.plane_thr", 0.05f);
  node_ptr->declare_parameter<int>("point_filter_num", 2);
  node_ptr->declare_parameter<std::string>("common.lid_topic", "/livox/lidar");
  node_ptr->declare_parameter<std::string>("common.imu_topic", "/livox/imu");
  node_ptr->declare_parameter<bool>("common.con_frame", false);
  ...
  node_ptr->declare_parameter<double>("mapping.acc_cov_input", 0.1);
  node_ptr->declare_parameter<double>("mapping.vel_cov", 20);
  node_ptr->declare_parameter<double>("mapping.gyr_cov_input", 0.1);
  node_ptr->declare_parameter<double>("mapping.gyr_cov_output", 0.1);
  node_ptr->declare_parameter<double>("mapping.acc_cov_output", 0.1);
  node_ptr->declare_parameter<double>("mapping.b_gyr_cov", 0.0001);
  node_ptr->declare_parameter<double>("mapping.b_acc_cov", 0.0001);
  node_ptr->declare_parameter<double>("mapping.imu_meas_acc_cov", 0.1);
  node_ptr->declare_parameter<double>("mapping.imu_meas_omg_cov", 0.1);
  node_ptr->declare_parameter<double>("preprocess.blind", 1.0);
  node_ptr->declare_parameter<int>("preprocess.lidar_type", 1);
  ...
  node_ptr->declare_parameter<std::vector<double>>("mapping.extrinsic_R", std::vector<double>());
  node_ptr->declare_parameter<bool>("odometry.publish_odometry_without_downsample", false);
  ...
  node_ptr->get_parameter("init_map_size", init_map_size);
  node_ptr->get_parameter("space_down_sample", space_down_sample);
  node_ptr->get_parameter("mapping.satu_acc", satu_acc);
  node_ptr->get_parameter("mapping.satu_gyro", satu_gyro);
  node_ptr->get_parameter("mapping.acc_norm", acc_norm);
  node_ptr->get_parameter("mapping.plane_thr", plane_thr);
  ...
  node_ptr->get_parameter("common.con_frame", con_frame);
  ...
  node_ptr->get_parameter("mapping.acc_cov_input", acc_cov_input);
  node_ptr->get_parameter("mapping.vel_cov", vel_cov);
  node_ptr->get_parameter("mapping.gyr_cov_input", gyr_cov_input);
  node_ptr->get_parameter("mapping.gyr_cov_output", gyr_cov_output);
  node_ptr->get_parameter("mapping.acc_cov_output", acc_cov_output);
  node_ptr->get_parameter("mapping.b_gyr_cov", b_gyr_cov);
  node_ptr->get_parameter("mapping.b_acc_cov", b_acc_cov);
  node_ptr->get_parameter("mapping.imu_meas_acc_cov", imu_meas_acc_cov);
  node_ptr->get_parameter("mapping.imu_meas_omg_cov", imu_meas_omg_cov);
  node_ptr->get_parameter("preprocess.blind", p_pre->blind);
  node_ptr->get_parameter("preprocess.lidar_type", lidar_type);
  ...
  node_ptr->get_parameter("odometry.publish_odometry_without_downsample", publish_odometry_without_downsample);
